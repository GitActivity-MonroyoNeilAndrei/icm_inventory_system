...
<div id="myCreate" class="fixed z-30 inset-x-0 top-10">
  <form action="{{ route('updatePassword', $user->id) }}" method="POST" class="flex flex-col items-center bg-white mx-auto w-80 rounded-lg shadow-xl pt-4 pb-1 px-8 border border-gray-700 overflow-y-auto" style="max-height: 80vh;">
    @csrf

    <h1 class="text-3xl font-bold leading-none">Change Password</h1>
    ...
    <div class="py-5 flex flex-col gap-3">
      <input type="submit" class="px-3 py-1 bg-blue-700 hover:bg-blue-800 rounded text-slate-200 cursor-pointer" value="Save">
