...
<div id="myCreate" class="fixed z-30 inset-x-0 top-10 hidden">
  <form action="{{ route('op.item.store' ) }}" method="POST" class="flex flex-col items-center bg-white mx-auto rounded-lg shadow-xl pt-4 pb-1  border border-gray-700 overflow-y-auto" style="max-height: 80vh; max-width: 40rem;">
    @csrf
