...
<div id="myFilter" class="fixed z-30 inset-x-0 top-10 hidden">
  <form action="{{ route('op.transaction.index') }}" method="GET" class="flex flex-col items-center bg-white mx-auto rounded-lg shadow-xl pt-4 pb-1 px-8  overflow-y-auto" style="max-height: 80vh; max-width: 40rem;">
    @csrf
