    ...
    <form action="{{ route('employee.update', $user->id) }}" method="post" class="flex items-center justify-center">
      ...
      @method('PUT')
        <div class="bg-white p-6 rounded-lg shadow-lg w-80">
            ...
            <h1 class="font-bold text-2xl text-center text-neutral-800">Edit Employee</h1>
            ...
            <div class="py-5 flex justify-center gap-4">
                <a class="px-3 py-1 bg-red-700 rounded  text-slate-200" href="{{ route('employee.index') }}">Cancel</a>
