<button id="openCreateButton" class="bg-blue-600 hover:bg-blue-500 px-3 py-1 rounded text-slate-200 shadow">
  Add Employee
</button>
...
<div id="myCreate" class="fixed z-30 inset-x-0 top-10 hidden">
  <form action="{{ route('employee.store' ) }}" method="POST" class="flex flex-col justify-center items-center bg-white mx-auto w-80 rounded-lg shadow-xl pt-4 pb-1 px-8 border border-gray-700">
    @csrf

    <h1 class="text-2xl font-semibold leading-none">Add Employee</h1>
