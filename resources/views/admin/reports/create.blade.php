...
<div id="myCreate" class="fixed z-30 inset-x-0 top-10">
  <form action="{{ route('report.store.txn', $item->id ) }}" method="POST" class="flex flex-col items-center bg-white mx-auto w-80 rounded-lg shadow-xl pt-4 pb-1 px-8 border border-gray-700 overflow-y-auto" style="max-height: 80vh;">
    @csrf
