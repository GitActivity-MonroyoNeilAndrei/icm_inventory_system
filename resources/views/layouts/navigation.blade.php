        ...
        <div class="px-0">
            ...
            <ul class="mt-10 ">
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-100 cursor-pointer items-center hover:bg-gray-700 " >
                    <a href="javascript:void(0)" class="px-10 py-3  w-full flex items-center focus:outline-none focus:ring-1 focus:ring-indigo-700">
                      <img class="w-4" src="{{ asset('images/dashboard-logo.png') }}" alt="">
                      <span class="text-sm ml-2">Dashboard</span>
                    </a>
                </li>
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-100 cursor-pointer items-center hover:bg-gray-700 {{ $nav == 'user' ? 'bg-gray-700' : '' }}">
                ...
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-100 cursor-pointer items-center hover:bg-gray-700 {{ $nav == 'items' ? 'bg-gray-700' : '' }}">
                ...
                <li class="px-10 flex w-full justify-between text-gray-400 hover:text-gray-100 cursor-pointer items-center py-3 hover:bg-gray-700">
