    ...
    <div style="min-height: 100vh" class="w-52 fixed top-0 left-0 bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex ">
        <div class="px-0">
            ...
            <ul class="mt-10 ">
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-100 cursor-pointer items-center hover:bg-gray-700 {{ Route::is('user.dashboard') ? 'bg-gray-700' : '' }}">
                    <a href="{{ route('user.dashboard') }}" class="px-10 py-3  w-full flex items-center focus:outline-none focus:ring-1 focus:ring-indigo-700">
                      <img class="w-4" src="{{ asset('images/dashboard-logo.png') }}" alt="">
                      <span class="text-sm ml-2">Dashboard</span>
                    </a>
                </li>
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-100 cursor-pointer items-center hover:bg-gray-700 {{ Route::is('user.item.index') ? 'bg-gray-700' : '' }}">
                    <a href="{{ route('user.item.index') }}" class="px-10 py-3 w-full flex items-center focus:outline-none focus:ring-1 focus:ring-indigo-700">
        ...
        <div class="px-10 border-t border-gray-700">
