...
class ReportController extends Controller
{
    ...
    public function storeTxn(Request $request, $id) {
        ...
        if(!$transaction->wasRecentlyCreated) {
            return redirect()->route('report.index')->with('failed', 'Transaction Already Exist');
        }
        ...
        return redirect()->route('report.index')->with('success', 'Transaction Added Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (auth()->user()->role === 'admin') {
            return redirect()->route('report.index')->with('TransactionUpdated', 'Item Updated Successfully');
        } else if (auth()->user()->role === 'user') {
            return redirect()->route('report.index')->with('TransactionUpdated', 'Item Updated Successfully');
        }
    }
